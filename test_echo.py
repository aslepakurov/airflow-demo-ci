...
from plugins.operators.bash_reader import BashReader
...
dag = DAG(
    dag_id='test_echo', default_args=args,
    schedule_interval='*/1 * * * *')


bash_this = BashOperator(task_id='test_echo', bash_command=script_to_run, params={"param": "test"}, dag=dag)
